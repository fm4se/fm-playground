...
public class DiffController {
  ...
  public String runDiffFromPermalink(
    ...
    try {
      ...
      return executeDiff(leftCode, rightCode, analysis, -1, true);
  ...
  private String executeDiff(String leftCode, String rightCode, String analysisStr, int scope, boolean withPred) {
    File leftFile = null;
    File rightFile = null;
    try {
      ...
      A4Solution ans = runTimed(new DiffRunner() {
        ...
        public A4Solution runDiff() {
          synchronized (ModuleDiff.class) {
            return ModuleDiff.diff(leftPath, rightPath, finalScope, finalWithPred, finalAnalysis);
          }
        }
